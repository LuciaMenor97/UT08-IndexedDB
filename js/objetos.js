...
Actor.prototype.getObject = function () {
...
Director.prototype.getObject = function () {
...
Interpretation.prototype.getObject = function () {
...
Movie.prototype.getObject = function () {
    ...
    return {
        ...
        localizaciones: devolverLocalizacion(this.locations),
        //localizaciones: this.locations,
        image: this.image
    };


    function devolverLocalizacion(value) {
...
Serie.prototype.getObject = function () {
    ...
    return {
        ...
        nacionalidad: this.nationality,
        sinopsis: this.synopsis,
        seasons: desplegarTemporadas(this.seasons),
        image: this.image
    };
...
Episodes.prototype.getObject = function () {
